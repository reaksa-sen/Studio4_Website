          ...
          <Link href={''}>
            <div className="mx-auto max-w-4xl p-4 pb-8 pt-8">
              ...
              <p className="py-5 font-semibold text-white">
                ...
                របស់រឿង​ក្រោយចេញវគ្គ ២ កាលពី ៣ឆ្នាំមុន ពោលគឺឆ្នាំ ២០១៩។ ដោយពេល​នេះ​ គឺ​ដល់ពេល
                កូនប្រុស របស់នាយ ស៊យ គឺ នាយ ចង្រៃ បញ្ចេញឬទ្ធិម្ដងហើយ។ ម្យ៉ាងទៀតនោះ
                បើតាមការបញ្ជាក់ពីលោក លៀក លីដា បាន​ឲ្យដឹង នាយ គ្រឿន បង្ហើបមកថានឹងមាន វគ្គ ៤
                ជាបន្តទៀត។
              </p>
              <Image
                alt={'image'}
